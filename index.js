...
app.get('/hospital', middleware.checkToken, (req,res)=>{
    console.log("things are getting ready");
...
app.post('/addvent',(req,res)=>{
    ...
    console.log("adding ventilator, please wait ");
...
app.put('/updateventilator', middleware.checkToken, (req,res) => {
    ...
    console.log("updating ventilator details, please wait ");
...
app.get('/searchventilators',(req,res)=>{
    const status=req.query.status;
    const name=req.query.name;
    console.log("searching ventilators, please wait ");
